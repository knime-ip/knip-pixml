...
public class OpsPixFeaturesNodeDialog<T extends RealType<T>> extends ValueToCellNodeDialog<ImgPlusValue<T>> {
    ...
    public void addDialogComponents() {
        ...
        //            FijiTrainSegFeaturesNodeModel.createMembraneThicknessModel(),
        //            "Membrane thickness", 1));
        //    addDialogComponent("Options", "Features", new DialogComponentNumber(
        //            FijiTrainSegFeaturesNodeModel.createMembranePatchSizeModel(),
        ...
        //            FijiTrainSegFeaturesNodeModel.createMultiThreadedModel(),
        //            "Multi-threaded"));
