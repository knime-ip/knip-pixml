 ...
 *
 */
package org.knime.knip.pixml.data.feat;
...
public class PixFeatureFactory<T extends RealType<T>> {
     ...
     * @param img
     */
    void updateImg(final Img<T> img) {
...
//    }
//
//    private void generateFeatImg(final Img<T> srcImg,
//            final RandomAccessibleInterval<FloatType> featImg/*, final Dart[] darts*/) {
//
//        updateImg(srcImg);
//
...
//                        getFeatureSetForFeatureIdx(feat);
